package com.zhejiang.haoxiadan.third.jiguang.chat.entity;
...
public class NotificationClickEventReceiver {
    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            Conversation conv;
            Intent notificationIntent = new Intent(mContext, com.zhejiang.haoxiadan.third.jiguang.chat.activity.MainActivity.class);
