package com.zhejiang.haoxiadan.model.requestData;

public class RefundApplyFormListData2 {
    ...
    public String getUserApplyImg() {
        return userApplyImg;
    }

    public void setUserApplyImg(String userApplyImg) {
