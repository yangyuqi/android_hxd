...
public class ShopFloorRectImgView extends AbsShopFloorView {
    ...
    public ShopFloorRectImgView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public ShopFloorRectImgView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView(){
        inflate(context, R.layout.view_shop_floor_rect_img, this);
