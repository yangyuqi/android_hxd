...
import com.zhejiang.haoxiadan.third.jiguang.chat.activity.FinishRegisterActivity;
import com.zhejiang.haoxiadan.third.jiguang.chat.activity.LoginActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_login:
                ...
                //登陆
                if (Constants.registerOrLogin % 2 == 1) {
            ...
            case R.id.new_user:
                ...
                Constants.registerOrLogin++;
                if (Constants.registerOrLogin % 2 == 0) {
