...
/**
 * 通用的界面顶部标题栏
 * Created by huangjinfu on 2016/1/7.
 */
public class CommonTitle extends LinearLayout {

    private final String TAG = "CommonTitle";
        ...
        mLlLeft.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnTitleClickListener != null) {
                    ...
                    Log.w(TAG, "mOnTitleClickListener == null");
                }
            }
        });

        mIvLeftIcon.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnTitleClickListener != null) {
                    mOnTitleClickListener.onLeftClick();
    ...
    public void showLeft(boolean isShow){
        mLlLeft.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }
}
