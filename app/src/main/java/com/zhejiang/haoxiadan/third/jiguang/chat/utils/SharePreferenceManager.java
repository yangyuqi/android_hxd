...
public class SharePreferenceManager {
    ...
    private static final String KEY_CACHED_CHATCOUNT = "jchat_cached_chat_count";
    public static void setCachedChatcount(int count) {
        if (null != sp) {
            sp.edit().putInt(KEY_CACHED_CHATCOUNT, count).apply();
        }
    }

    public static int getCachedChatcount() {
        if (null != sp) {
            return sp.getInt(KEY_CACHED_CHATCOUNT, 0);
        }
        return 0;
    }
