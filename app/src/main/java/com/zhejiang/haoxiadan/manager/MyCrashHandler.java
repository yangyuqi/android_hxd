package com.zhejiang.haoxiadan.manager;
...
import com.zhejiang.haoxiadan.util.FileStorage;
import com.zhejiang.haoxiadan.util.LogUtils;
...
public class MyCrashHandler implements UncaughtExceptionHandler {
    ...
    private String CRASH_DIRECTORY = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator +"hxd_crash";
    // 用来存储设备信息和异常信息
